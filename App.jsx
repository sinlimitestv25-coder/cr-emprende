      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-[1.15fr_.85fr] rounded-[2.2rem] overflow-hidden glass-panel relative z-10 shadow-2xl shadow-blue-950/40 border border-white/10">
        <div className="p-7 md:p-10 bg-gradient-to-br from-slate-950/92 via-black/72 to-slate-900/72">
          <div className="flex justify-center">
            <div className="relative inline-flex rounded-[1.5rem] bg-white/95 px-4 py-2 shadow-2xl shadow-blue-600/25 border border-white/40 overflow-hidden">
              <img src="/logo-cr.png" alt="C&R Emprende" className="h-44 w-auto object-contain" />
              <span className="absolute right-3 bottom-6 -rotate-12 rounded-full bg-gradient-to-r from-sky-500 via-cyan-400 to-emerald-300 px-5 py-1.5 text-lg font-black uppercase tracking-[0.18em] text-slate-950 shadow-xl shadow-sky-900/25 border border-white/60">
                Emprende
              </span>
            </div>
          </div>
          ...
          <div className="mt-8 max-w-2xl">
            <p className="text-sm text-sky-300 font-black uppercase tracking-[0.24em]">Emprende</p>
